...
%\includeonly{sinitsyn}    %1безрис+pdf(м)
%\includeonly{pechinkin}  %2+авт+pdf(м)
%\includeonly{morozov}  %%3безрис+pdf+авт
%\includeonly{bosov}      %4без рис++pdf(м)
%\includeonly{kudr}       %5+без рис+pdf(м)
%\includeonly{mironov}  %6+pdf+авт(м)
%\includeonly{adigeev}          %7+pdf(м)
%\includeonly{zaharova}         %8+pdf(м)
%\includeonly{str-mot}   %9+pdf(м)
%\includeonly{zatsman}   %10+pdf(м)
%\includeonly{spivak}    %11+pdf(м)авт
%\includeonly{matskevich} %12+pdf(м)
%\includeonly{kuznetsov}     %13+pdf(м)
%\includeonly{ubilei3}
...
\include{sinitsyn} %1+авт
\include{pechinkin}  %2+авт
\include{morozov}  %3+авт
\include{bosov}    %4+авт
\include{kudr}   %5+авт
\include{mironov}  %6+авт
\include{adigeev}  %7+авт
\include{zaharova}  %8+авт
\include{str-mot}  %9+авт
\include{zatsman}  %10
\include{spivak}   %11+авт
\include{matskevich} %12+авт
\include{kuznetsov} %13
