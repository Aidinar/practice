...
%\includeonly{shestakov}  %+pdf+авт+правкиАвт
%\includeonly{morozov}  %+pdf+авт+правкиАвт
%\includeonly{vasil}   %+pdf+авт+правкиАвт
%\includeonly{zykin}  %+pdf+авт+правкиАвт
%\includeonly{malashenko} %+авт+pdf
%\includeonly{kireev} %+авт+pdf
%\includeonly{sinitsin}  %+pdf+авт+правкиАвт
%\includeonly{sokolov}  %+авт+pdf+правкиАвт
%\includeonly{pavlov}  %+pdf+авт+правкиАвт
%\includeonly{arkhipov} %+авт+pdf
%\includeonly{zeifmann}  %+авт+pdf+правкиАвт
%\includeonly{kozerenko} %+авт+pdf
%\includeonly{lupentsov}  %+авт+pdf+правкиАвтОК
