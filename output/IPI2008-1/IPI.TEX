...
%\includeonly{sinits} %есть
%\includeonly{bosov}  %есть
%\includeonly{pech}  %есть
%\includeonly{zahar}
%\includeonly{zatsman} %есть
%\includeonly{paper1}
%\includeonly{paper6}
...
\hfill ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~2\ \ \ выпуск~1\ \ \ 2008}
}%
 \def\rightfootline{\small{ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~2\ \ \ выпуск~1\ \ \ 2008
