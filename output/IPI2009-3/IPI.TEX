...
%\includeonly{pechin} %1+pdf
%\includeonly{shestakov} %6+
%\includeonly{temnov}  %5+pdf
%\includeonly{zeifman} %+2+pdf
%\includeonly{shevtsova} %9+pdf
%\includeonly{morozov}  %3+pdf
%\includeonly{chuprunov} %7
%\includeonly{korolev}   %8+pdf
%\includeonly{bening}   %10pdf
%\includeonly{borodak}   %4+pdf
...
\hfill ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~3\ \ \ выпуск 3\ \ \ 2009}
}%
 \def\rightfootline{\small{ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~3\ \ \ выпуск~3\ \ \ 2009
