...
%\includeonly{korolev} %1pdf+
%\includeonly{sinitsin} %+2pdf+
%\includeonly{bosov}  %3pdf+
%\includeonly{ushakov} %+4pdf+
%\includeonly{popov}  %5pdf+
%\includeonly{konovalov}  %5-1pdf+
%\includeonly{kuznetsov}  %5-2+pdf+
%\includeonly{benderina}  %5-3pdf
%\includeonly{kalinich}  %5-4+pdf
%\includeonly{pred}  %pdf
%\includeonly{torshin} %+6pdf+
%\includeonly{belyh}   %+7pdf+
%\includeonly{gudkov}  %+8pdf+
%\includeonly{vilz}    %9pdf+
%\includeonly{kurakin} %10pdf+
%\includeonly{murashov} %11+pdf+
%\includeonly{ushmaev}  %12+pdf
...
\include{ushakov}    %4
\include{popov}    %5
\include{konovalov}  %5-1
\include{kuznetsov}  %5-2
\include{benderina}  %5-3
\include{kalinich}  %5-4
\include{pred}
\include{torshin}   %6
\include{belyh}   %7
\include{gudkov}   %8
