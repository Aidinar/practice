...
%\includeonly{sinitsin} %1pdf+авт
%\includeonly{gaidamaka} %2pdf+авт
%\includeonly{dolev}  %3pdf+авт
%\includeonly{kalinichenko}  %4
%\includeonly{kovalev} %5pdf+авт
%\includeonly{sinis+korep} %6+pdf+авт
%\includeonly{popova} %7pdf
%\includeonly{spivak}  %8pdf+авт
%\includeonly{kudr}   %9pdf+авт
%\includeonly{korchag} %10pdf+авт
...
\include{gaidamaka} %2
\include{dolev}  %3
\include{kalinichenko}  %4
\include{kovalev} %5
\include{sinis+korep} %6
\include{popova} %7
\include{spivak}  %8
\include{kudr}   %9
\include{korchag} %10
