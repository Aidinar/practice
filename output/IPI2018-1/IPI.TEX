...
%\includeonly{serebr}                 %+1pdf+отпр+авт+
%\includeonly{mal-naz-1}              %+2pdf+отпр+авт+
%\includeonly{flerov}                 %3+вышинскийpdf+отпр+авт+
%\includeonly{agasand}                %+4pdfотпр+авт+
%\includeonly{aleshin}                %+5pdfотпр+авт+
%\includeonly{vinogr}                 %6pdfотпр+авт+
%\includeonly{sinits}                 %+7pdfотпр+авт+
%\includeonly{grusho}                 %8pdfотпр+авт+
%\includeonly{krivenko}               %9pdfотпр+авт+
%\includeonly{zatsar}                 %10pdfотпр+авт+
%\includeonly{sochenkov}              %11pdfотправт+
%\includeonly{kovalev}                %12pdfотпр+авт+
%\includeonly{kudr}                   %+13pdfотпр+авт+
%\includeonly{shurkov}                %+14pdfотпр
%\includeonly{sunterenko}             %15pdfотпр+авт+
...
\hfill ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~12\ \ \ выпуск 1\ \ \ 2018}
}%
 \def\rightfootline{\small{ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~12\ \ \ выпуск~1\ \ \ 2018
\hfill \textbf{\thepage}}}
...
\include{krivenko} %9 
\include{zatsar}  %10
\include{sochenkov} %11
\include{kovalev}  %12
\include{kudr}     %13
\include{shurkov}  %14
\include{sunterenko} %15
