...
%\includeonly{sinit} %1
%\includeonly{ushmaev} %2
%\includeonly{nasonov}  %2+1
%\includeonly{shestakov} %2+2
%\includeonly{egorov} %3+2
...
\hfill ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~3\ \ \ выпуск 1\ \ \ 2009}
}%
 \def\rightfootline{\small{ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~3\ \ \ выпуск~1\ \ \ 2009
