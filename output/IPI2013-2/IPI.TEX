...
%\includeonly{malashenko} %2pdf
%\includeonly{borodina}   %3+pdf
%\includeonly{razum} %4pdf
%\includeonly{shestakov} %5pdf
%\includeonly{korolev} %6pdf
%\includeonly{kudr} %7pdf
%\includeonly{timofeev} %8pdf
%\includeonly{haplanov} %9pdf
%\includeonly{bening}   %10pdf
%\includeonly{zaks} %11pdf
%\includeonly{kozerenko} %12pdf
...
\hfill ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~7\ \ \ выпуск 2\ \ \ 2013}
}%
 \def\rightfootline{\small{ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~7\ \ \ выпуск~2\ \ \ 2013
\hfill \textbf{\thepage}}} 
...
\include{sinits} %1 Abst
\include{malashenko} %2 
\include{borodina}    %3
\include{razum} %4  Abst
\include{shestakov} %5
\include{korolev}  %6Abst???
\include{kudr} %7  %Abst
\include{timofeev} %8Abst
\include{haplanov}   %9Abst
\include{bening}    %10Abst
\include{zaks}   %11Abst
\include{kozerenko} %12Abst
\include{zatsman}  %13
