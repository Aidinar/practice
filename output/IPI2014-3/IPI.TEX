...
%\includeonly{korolev} %1            +pdf+авт
%\includeonly{sinits} %+pdf %2
%\includeonly{zeifman}               %авт+pdf
%\includeonly{meykh} %4               +авт+pdf
%\includeonly{ushakov}           %pdf %5+авт
%\includeonly{agalarov} %+pdf %6
%\includeonly{borisov}  %+pdf%7
%\includeonly{krivenko} %+pdf             +авт+
%\includeonly{yakovleva}  %+pdf%9    +авт
%\includeonly{zykova} %pdf%10        %авт
%\includeonly{maniakov} %+pdf%11      +авт
%\includeonly{plehanov}  %+pdf%12     +авт
%\includeonly{zatsman} %+pdf %13      +авт
%\includeonly{zatsar} %14             +авт+pdf
...
\hfill ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~8\ \ \ выпуск 3\ \ \ 2014}
}%
 \def\rightfootline{\small{ИНФОРМАТИКА И ЕЁ ПРИМЕНЕНИЯ\ \ \ том~8\ \ \ выпуск~3\ \ \ 2014
\hfill \textbf{\thepage}}}
